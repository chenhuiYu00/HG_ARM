...
class Ui_Main_GUI(object):
    def setupUi(self, Main_GUI):
        ...
        # Main_GUI.setStyleSheet("background-image: url(logo/hg_logo.jpg);")
        ...
        # Main_GUI.setStyleSheet("#MainWindow{border-image:url(./logo/arm.png);}")
...
"font: 14pt \"AcadEref\";")
        ...
        self.logo.setStyleSheet("border-image: url(:/gui_logo/logo.jpg);")
...
"font: 14pt \"AcadEref\";")
        ...
        self.pushButton_4.setStyleSheet("QPushButton{border-image: url(logo/check.png);font: 14pt \"AcadEref\";}")
...
# "border-style: outset;")
        ...
        self.pushButton_6.setStyleSheet("QPushButton{border-image: url(logo/write.png);font: 14pt \"AcadEref\";}")
...
# "border-style: outset;")
        ...
        self.pushButton_9.setStyleSheet("QPushButton{border-image: url(logo/write_board.png);font: 14pt \"AcadEref\";}")
...
# "border-style: outset;")
        ...
        self.pushButton.setStyleSheet("QPushButton{border-image: url(logo/teach.png);font: 14pt \"AcadEref\";}")
...
# "color: rgb(85,85,0);  \n"
# "font: 14pt \"AcadEref\";\n"
# "border-image: url(logo/teach.png);\n"
# "border-style: outset;")
        ...
        self.pushButton_8.setStyleSheet("QPushButton{border-image: url(logo/draw_board.png);font: 14pt \"AcadEref\";}")
...
# "border-style: outset;")
        ...
        self.pushButton_7.setStyleSheet("QPushButton{border-image: url(logo/expand.png);font: 14pt \"AcadEref\";}")
...
# "border-style: outset;")
        ...
        self.pushButton_2.setStyleSheet("QPushButton{border-image: url(logo/rem.png);font: 14pt \"AcadEref\";}")
...
# "border-style: outset;")
        ...
        self.pushButton_5.setStyleSheet("QPushButton{border-image: url(logo/draw.png);font: 14pt \"AcadEref\";}")
...
# "border-style: outset;")
        ...
        self.pushButton_3.setStyleSheet("QPushButton{border-image: url(logo/execute.png);font: 14pt \"AcadEref\";}")
...
"color: rgb(255, 50, 90);")
        ...
        self.x.setGeometry(QtCore.QRect(774, 230, 55, 31))
        ...
        self.y.setGeometry(QtCore.QRect(774, 295, 55, 31))
        ...
        self.point_x.setGeometry(QtCore.QRect(840, 230, 80, 35))
...
"padding:2px 4px;")
        ...
        self.point_y.setGeometry(QtCore.QRect(840, 295, 80, 35))
...
"padding:2px 4px;")
        ...
        self.add_x.setGeometry(QtCore.QRect(940, 220, 60, 60))
...
"border-radius: 30px;  ")
        ...
        self.less_x.setGeometry(QtCore.QRect(1030, 220, 60, 60))
...
"border-radius: 30px; ")
        ...
        self.add_y.setGeometry(QtCore.QRect(940, 285, 60, 60))
...
"border-radius: 30px;")
        ...
        self.less_y.setGeometry(QtCore.QRect(1030, 285, 60, 60))
...
"border-radius: 30px;")
        ...
        self.add_angle3.setGeometry(QtCore.QRect(940, 590, 60, 60))
...
"border-radius: 30px; ")
        ...
        self.angle_2.setGeometry(QtCore.QRect(840, 530, 80, 35))
...
"padding:2px 4px;")
        ...
        self.less_angle3.setGeometry(QtCore.QRect(1030, 590, 60, 60))
...
"border-radius: 30px; ")
        ...
        self.add_angle2.setGeometry(QtCore.QRect(940, 520, 60, 60))
...
"border-radius: 30px;")
        ...
        self.less_angle2.setGeometry(QtCore.QRect(1030, 520, 60, 60))
...
"border-radius: 30px;")
        ...
        self.angle_1.setGeometry(QtCore.QRect(840, 460, 80, 35))
...
"padding:2px 4px;")
        ...
        self.add_angle1.setGeometry(QtCore.QRect(940, 450, 60, 60))
...
"border-radius: 30px; ")
        ...
        self.angle2.setGeometry(QtCore.QRect(774, 530, 55, 31))
        ...
        self.less_angle1.setGeometry(QtCore.QRect(1030, 450, 60, 60))
...
"border-radius: 30px; ")
        ...
        self.angle_3.setGeometry(QtCore.QRect(840, 600, 80, 35))
...
"padding:2px 4px;")
        ...
        self.angle3.setGeometry(QtCore.QRect(774, 600, 55, 31))
        ...
        self.angle1.setGeometry(QtCore.QRect(774, 460, 55, 31))
...
"}")
        ...
        self.pos_slider = QtWidgets.QSlider(Main_GUI)
        self.pos_slider.setGeometry(QtCore.QRect(770, 190, 251, 21))
        self.pos_slider.setMaximum(100)
        self.pos_slider.setSingleStep(10)
        self.pos_slider.setPageStep(10)
        self.pos_slider.setProperty("value", 10)
        self.pos_slider.setOrientation(QtCore.Qt.Horizontal)
        self.pos_slider.setObjectName("pos_slider")
        self.angle_slider = QtWidgets.QSlider(Main_GUI)
        self.angle_slider.setGeometry(QtCore.QRect(770, 420, 251, 21))
        self.angle_slider.setMaximum(50)
        self.angle_slider.setSingleStep(5)
        self.angle_slider.setPageStep(5)
        self.angle_slider.setProperty("value", 5)
        self.angle_slider.setOrientation(QtCore.Qt.Horizontal)
        self.angle_slider.setObjectName("angle_slider")
        self.angle_data = QtWidgets.QLineEdit(Main_GUI)
        self.angle_data.setGeometry(QtCore.QRect(1030, 420, 61, 26))
        self.angle_data.setReadOnly(True)
        font = QtGui.QFont()
        font.setPointSize(15)
        self.angle_data.setFont(font)
        self.angle_data.setAlignment(QtCore.Qt.AlignCenter)
        self.angle_data.setObjectName("angle_data")
        self.pos_data = QtWidgets.QLineEdit(Main_GUI)
        self.pos_data.setGeometry(QtCore.QRect(1030, 190, 61, 26))
        self.pos_data.setReadOnly(True)
        font = QtGui.QFont()
        font.setPointSize(15)
        self.pos_data.setFont(font)
        self.pos_data.setAlignment(QtCore.Qt.AlignCenter)
        ...
        self.pos_slider.valueChanged.connect(Main_GUI.set_pos_move)
        ...
        self.angle_slider.valueChanged.connect(Main_GUI.set_angle_move)
    ...
    def retranslateUi(self, Main_GUI):
        ...
        self.pos_data.setText(_translate("Main_GUI", "10"))
        self.angle_data.setText(_translate("Main_GUI", "5"))
